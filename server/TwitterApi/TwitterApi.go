...
func GetTwsByQuery(query string) Data[[]TwitterTweetStructure] {
...
func GetTwCount(query, granularity string) Data[[]tweetCount] {
	...
	result := utils.UnmarshalToJson[Data[[]tweetCount]](body)
