    ...
    >
      ...
      <div className="relative w-full">
        ...
        {props.selectValue === "date" ?
          <button
          type="submit"
          className="absolute top-12 right-20 p-2.5 text-sm font-large text-white bg-blue-700 rounded-r-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            <svg
              aria-hidden="true"
              className="w-5 h-5"
